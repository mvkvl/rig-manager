...
public class IpMonitorClientRunner implements CommandLineRunner {

    private static final Logger logger = LoggerFactory.getLogger(IpMonitorClientRunner.class);
    ...
    public void run(String... arg0) throws InterruptedException {
        telegramNotifier.sendMessage(" <b>ip-mon-client</b>: service started");
